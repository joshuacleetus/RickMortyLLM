...
public class CharactersQuery: GraphQLQuery {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query Characters($page: Int) { characters(page: $page) { __typename info { __typename count pages next prev } results { __typename id name status species image } } }"#
    ))
  ...
  public struct Data: RickMortyAPI.SelectionSet {
    ...
    public struct Characters: RickMortyAPI.SelectionSet {
      public let __data: DataDict
      public init(_dataDict: DataDict) { __data = _dataDict }

      public static var __parentType: any ApolloAPI.ParentType { RickMortyAPI.Objects.Characters }
      public static var __selections: [ApolloAPI.Selection] { [
      ...
      ///
      /// Parent Type: `Info`
      public struct Info: RickMortyAPI.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }

        public static var __parentType: any ApolloAPI.ParentType { RickMortyAPI.Objects.Info }
        public static var __selections: [ApolloAPI.Selection] { [
          .field("__typename", String.self),
      ...
      public struct Result: RickMortyAPI.SelectionSet {
        public let __data: DataDict
        public init(_dataDict: DataDict) { __data = _dataDict }
